...
import { SLAYER_VARBITS } from '../services/SlayerService';
 ...
 */
export const REQUIRED_VARBITS = [...QUEST_VARBITS, ...DIARY_VARBITS, ...SLAYER_VARBITS, 3637, 3202, 3207, 3208, 5358, 10663, 10664, 10665, 10666,
